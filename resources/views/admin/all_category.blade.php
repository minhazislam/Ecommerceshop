						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="{{URL::to('fulfill-category/'.$v_category->category_id)}}">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" onclick="return confirm('আপনি কি নিশ্চিত?')" href="{{URL::to('/delete-category/'.$v_category->category_id)}}" {{-- id="delete" --}}>
